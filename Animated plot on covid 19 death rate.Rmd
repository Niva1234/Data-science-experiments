---
title: " Animated graph on covid-19 death cases"
author: "Niva P saji"
date: "2/9/2021"
...
staticplot = ggplot(death10, aes(rank, group = Country.Region, 
  ...
  geom_tile(aes(y = Deaths/2,height = Deaths,width = 0.6), alpha = 0.8, color = NA) +
  geom_text(size=7,aes(y = 0, label = paste(Country.Region, " ")), vjust = 0.5, hjust = 1) +
  ...
  theme(axis.line=element_blank(),
        ...
        panel.grid.minor.x = element_line( size=.1, color="blue" ),
        plot.title=element_text(size=27, hjust=0.5, face="bold", colour="black", vjust=-1),
        plot.subtitle=element_text(size=17, hjust=0.5, face="italic", color="blue"),
        plot.caption =element_text(size=8, hjust=0.5, face="italic", color="blue"),
        plot.background=element_blank(),
        plot.margin = margin(3,4, 2, 12, "cm"))
